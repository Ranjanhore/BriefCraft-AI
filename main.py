...
def get_project(project_id: str) -> Optional[Dict[str, Any]]:
    ...
    project = dict(row)
    for key in ["concepts", "selected", "images", "render3d", "scene_json", "deliverables", "dimensions", "brand_data", "presentation_data"]:
...
# DB: FILES
# =========================
def add_project_file(project_id: str, user_id: Optional[str], file_type: str, file_name: str, file_url: str, meta: Optional[dict] = None):
    cur = get_cursor()
    cur.execute(
        """
